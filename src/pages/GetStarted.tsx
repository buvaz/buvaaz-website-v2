    ...
    <div>
            ...
            <div className="form-4">
              <div className="form-4 w-form">
                <form
                  ...
                  method="get"
                  className="form-2"
                  data-wf-page-id="68c034335677df96e4cf618f"
              ...
              <div className="w-layout-grid grid">
                <div className="div-block-39">
                  <a href="#" className="continue-as-creator w-inline-block">
                    ...
                    <div className="text-block-29">I&#x27;m a Creator </div>
                    <div className="text-block-30">
                      I want to earn commission selling products on social
                      media, Whatsapp, TikTok and Snap and more!
                    </div>
                    <div className="text-block-30-copy">
                ...
                <a href="#" className="continue-as-business w-inline-block">
                  ...
                  <div className="text-block-30">
                    ...
                    support, plus inquiries and support.
                  </div>
                  <div className="text-block-30-copy">
      ...
      <div className="my-20">
        ...
        <div className="div-block-20">
          <a href="#" className="primacta w-inline-block">
